...
@implementation UKHomeCollectionViewCell
...
- (void)setModel:(UKDeviceModel *)model{
    ...
    if ([model.status isEqualToString:@"offline"]) {
        ...
        _backgroundImgView.image = [UIImage imageNamed:@"Background8"];
        
    } else {
        
        _offlineImgView.hidden = YES;
        
        _backgroundImgView.image = [UIImage imageNamed:@"Background3"];
